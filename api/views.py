...
from .serializers import UserSerializer, MessageSerializer, ChannelSerializer, LoginSerializer, \
    ChangePasswordSerializer, LeaveChannelSerializer
...
class UserViewSet(viewsets.ModelViewSet):
    ...
    filterset_fields = ['username', 'email', 'first_name', 'last_name', 'channels', 'owned_channels']
...
class LeaveChannelViewSet(views.APIView):
    ...
    def post(request):
        ...
        User.objects.get(id=request.user.id).channels.get(pk=serializer.data['channel']).delete()
